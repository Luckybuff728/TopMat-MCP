...
// OpenRouter 完成 API
// ================================================================
/// `qwen/qwq-32b` 模型。在 <https://openrouter.ai/models> 查找更多模型。
pub const QWEN_QWQ_32B: &str = "qwen/qwq-32b";
/// `anthropic/claude-3.7-sonnet` 模型。在 <https://openrouter.ai/models> 查找更多模型。
pub const CLAUDE_3_7_SONNET: &str = "anthropic/claude-3.7-sonnet";
/// `perplexity/sonar-pro` 模型。在 <https://openrouter.ai/models> 查找更多模型。
pub const PERPLEXITY_SONAR_PRO: &str = "perplexity/sonar-pro";
/// `google/gemini-2.0-flash-001` 模型。在 <https://openrouter.ai/models> 查找更多模型。
