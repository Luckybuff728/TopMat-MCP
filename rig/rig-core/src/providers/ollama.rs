//! Ollama API 客户端和 Rig 集成
//!
//! # 示例
//! ```rust
//! use rig::providers::ollama;
//!
//! // 创建一个新的 Ollama 客户端（默认为 http://localhost:11434）
//! let client = ollama::Client::new();
//!
//! // 使用例如 "llama3.2" 模型创建完成模型接口
...
use reqwest;
// use reqwest_eventsource::{Event, RequestBuilderExt}; // （当前未使用，因为 Ollama 不支持 SSE）
...
const OLLAMA_API_BASE_URL: &str = "http://127.0.0.1:11434";
